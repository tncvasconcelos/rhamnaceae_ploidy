...
test_run <- GetRanges(points=all_dist_points, species="Species", lat="Latitude", lon="Longitude", threshold=0.75, buffer=25, res=10)
saveRDS(test_run, file="distribution_models_75.Rdata")
